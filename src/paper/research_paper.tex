...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\textwidth]{../../bld/out/figures/ma_signal_regime_BTC_POT_10_25}
    \label{fig:figure1}
\end{figure}

\begin{figure}[!ht]
    \centering
    \includegraphics[width=\textwidth]{../../bld/out/figures/ma_price_BTC_POT_10_25}
    \label{fig:figure2}
\end{figure}

\begin{figure}[!ht]
    \centering
    \includegraphics[width=\textwidth]{../../bld/out/figures/ma_signal_regime_BTC_POT_20_50}
    \label{fig:figure3}
\end{figure}

\begin{figure}[!ht]
    \centering
    \includegraphics[width=\textwidth]{../../bld/out/figures/ma_price_BTC_POT_20_50}
    \label{fig:figure4}
\end{figure}

\begin{figure}[!ht]
    \centering
    \includegraphics[width=\textwidth]{../../bld/out/figures/ma_signal_regime_BTC_POT_50_100}
    \label{fig:figure5}
\end{figure}

\begin{figure}[!ht]
    \centering
    \includegraphics[width=\textwidth]{../../bld/out/figures/ma_price_BTC_POT_50_100}
    \label{fig:figure6}
\end{figure}
% section results (end)
